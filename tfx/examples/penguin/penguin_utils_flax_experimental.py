...
#
def _make_trained_model(train_data: Iterator[Tuple[_InputBatch, _LabelBatch]],
                        eval_data: Iterator[Tuple[_InputBatch, _LabelBatch]],
...
def _train_epoch(model: _FlaxPenguinModel, optimizer: flax.optim.OptimizerDef,
                 train_data: Iterator[Tuple[_InputBatch, _LabelBatch]],
                 steps_per_epoch: int):
